...
- (void)viewWillAppear:(BOOL)animated
{
	...
	[MSDBCall  getHistory:thearray db:appDelegate.database];
	[thetable reloadData];
	[appDelegate trackpage:@"/History"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tv cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	{
		cell.imageView.image =[UIImage imageNamed:@"his.png"];
	}
...
forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) 
	{
		...
		[MSDBCall deletefromHistory:aitem databse:appDelegate.database];
		[MSDBCall  getHistory:thearray db:appDelegate.database];
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
	...
	theDetail.calledbyFavorites = NO;
